...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      setResult({message:"Sending....", type:"success"});
      const formData = new FormData(event.target);
  
      formData.append("access_key", "0e8e4013-e75d-469c-89a0-298f82d79a5f");
    ...
    onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        bg-black/80 text-white rounded-full mx-auto hover:bg-black duration:500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit now
