  ...
  return (
    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='flex-1'>
            <p className='mb-10 max-w-2xl font-Ovo'>I am a dedicated MCA graduate with expertise in web development and data analytics. 
                ...
                I bring a blend of technical skills and creative problem-solving to every project.
                 ...
                 My journey is driven by a commitment to learning, innovation, and delivering solutions that make a difference.</p>
