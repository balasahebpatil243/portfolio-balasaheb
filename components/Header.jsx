...
const Header = () => {
  return (
    <div className='w-11/12 max-w-4xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-xl md:text-2xl nb-3 font-Ovo'>Hi! I'm Balasaheb Patil<Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
        <motion.h1 
        ...
        className='max-w-2xl mx-auto font-Ovo'>I am an MCA graduate skilled in data analytics and web development. I enjoy turning data into insights and building responsive, user-focused web applications. 
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                href="./Balasaheb-resume.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>
